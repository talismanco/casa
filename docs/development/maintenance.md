...
We encourage everyone to run the [latest stable release](https://github.com/toyboxco/casa/releases) (the latest stable release is also reflected in the current state of the [master branch](https://github.com/toyboxco/casa))
