...
Following a successful merge, The [Release Github Action](./workflows/release.yaml), power will fire: determining the next version number, generating the release notes and publishing the package - powered by [semantic-release](https://github.com/semantic-release/semantic-release). Semantic release follows the commit message guidelines provided by [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/)
